...
// x + 0x1000000
#define SYSCALL_MACH(x) ((SYSCALL_CLASS_MACH << SYSCALL_CLASS_SHIFT) | (SYSCALL_NUMBER_MASK & (x)))

// x + 0x2000000
//#define SYSCALL_UNIX(x) ((SYSCALL_CLASS_UNIX << SYSCALL_CLASS_SHIFT) | (SYSCALL_NUMBER_MASK & (x)))
#define SYSCALL_UNIX(x) (x)

// x + 0x3000000
#define SYSCALL_MDEP(x) ((SYSCALL_CLASS_MDEP << SYSCALL_CLASS_SHIFT) | (SYSCALL_NUMBER_MASK & (x)))
...
z_int64 z_syscall_unix(z_int32 n, ...);
z_int64 z_syscall_mach(z_int32 n, ...);
